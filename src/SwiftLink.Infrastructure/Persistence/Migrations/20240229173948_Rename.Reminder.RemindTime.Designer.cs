...
namespace SwiftLink.Infrastructure.Migrations
{
    ...
    [Migration("20240229173948_Rename.Reminder.RemindTime")]
    partial class RenameReminderRemindTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SwiftLink.Domain.Entities.Link", b =>
                {
                    ...
                    b.OwnsMany("SwiftLink.Domain.Entities.Tags", "Tags", b1 =>
                        {
